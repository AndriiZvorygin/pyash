...
- **Test-first workflow**: Red→green enforced; new features start with failing tests. Chosen to enable evolutionary growth and safe model proposals; informal ad-hoc coding was rejected.
