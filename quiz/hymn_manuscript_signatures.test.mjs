...
test("hymn manuscript module keeps educational staged flow with verify platform", async () => {
  ...
  assert.match(text, /ob name text hymn hook source to name text hymn hook candidates raw out be text do/);
  assert.doesNotMatch(text, /su name hymn hook sieve stage from text of ob of hymn hook source with text of ob of hymn hook candidates raw out to name text hymn hook candidates out be hymn hook sieve do/);
