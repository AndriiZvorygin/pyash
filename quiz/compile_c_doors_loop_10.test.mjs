...
test("compile to C: 10-doors nested loops", async () => {
  forget();

  const pyash = await fs.readFile("examples/pyash/doors-loop-10.pya", "utf8");
  ...
  assert.equal(stdout.trim(), "ve bool truth lie lie truth lie lie lie lie truth lie");
});
