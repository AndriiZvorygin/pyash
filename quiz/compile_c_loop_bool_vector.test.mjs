...
test("compile to C: loop toggles boolean vector at fromindex", async () => {
  forget();

  const pyash = await fs.readFile("examples/pyash/loop-bool-toggle-index.pya", "utf8");
  ...
  assert.equal(stdout.trim(), "ve bool lie truth lie");
});
