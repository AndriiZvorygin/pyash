...
test("compile to C: 100 doors nested loops", async () => {
  forget();

  const pyash = await fs.readFile("examples/pyash/doors-loop-100.pya", "utf8");
  ...
  assert.equal(stdout.trim(), doorsExpectedLiteral(100));
});
