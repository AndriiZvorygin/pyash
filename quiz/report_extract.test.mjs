...
test("extract_report emits deterministic report from newspaper", async () => {
  ...
  const expected = [
    ...
    "su name platform activity ob la exists su name marker ob text \"ok\" be text ya ko ya",
    "su name platform result ob la exists su name marker ob text \"ok\" be text ya ko ya",
