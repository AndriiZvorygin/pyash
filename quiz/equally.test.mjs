...
test("equally conditional controls next statement with inline values", async () => {
  ...
  await run("ob num 2 to name collector be add do"); // should run (5 === 5)
...
test("equally compares su against literal", async () => {
  ...
  await run("ob num 1 to name collector be add do"); // should run (collector.num === 4)
...
test("equally compares su against another su value", async () => {
  ...
  await run("ob num 1 to name lhs be add do"); // should run (5 === 5)
