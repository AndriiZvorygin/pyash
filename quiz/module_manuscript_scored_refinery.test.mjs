...
test("module manuscript scored module exports checkpoint-first helper ceremonies", async () => {
  ...
  assert.match(moduleSource, /module manuscript scored promote candidate attempt name ob attempt_name of from of this be nickname/u);
  assert.match(moduleSource, /module manuscript scored promote candidate score ob score of from of this be nickname/u);
  assert.match(moduleSource, /ob text "history" to name module manuscript scored promote history slot be text do/u);
  assert.match(moduleSource, /ob num of name module manuscript scored promote candidate score to name module manuscript scored promote score slot be plus do/u);
  assert.match(moduleSource, /ob name module manuscript scored promote candidate attempt name to name module manuscript scored promote best attempt slot be text do/u);
  assert.match(moduleSource, /ob num of name module manuscript scored promote candidate score to name module manuscript scored promote best score slot be plus do/u);
  assert.match(moduleSource, /module manuscript scored collect pair best attempt slot/u);
  assert.match(moduleSource, /module manuscript scored collect pair source attempt name ob attempt_name of from of this be nickname/u);
