...
test("read pdf markdown extracts text", { skip: !(pdftohtmlAvailable && pandocAvailable) }, async () => {
  ...
  const escaped = String(source).replace(/[()\\]/g, match => `\\${match}`);
  const content = `BT\n/F1 24 Tf\n72 120 Td\n(${escaped}) Tj\nET`;
  const objects = [
    "1 0 obj\n<< /Type /Catalog /Pages 2 0 R >>\nendobj\n",
    "2 0 obj\n<< /Type /Pages /Kids [3 0 R] /Count 1 >>\nendobj\n",
    "3 0 obj\n<< /Type /Page /Parent 2 0 R /MediaBox [0 0 300 144] /Contents 4 0 R /Resources << /Font << /F1 5 0 R >> >> /Annots [6 0 R] >>\nendobj\n",
    `4 0 obj\n<< /Length ${Buffer.byteLength(content)} >>\nstream\n${content}\nendstream\nendobj\n`,
    "5 0 obj\n<< /Type /Font /Subtype /Type1 /BaseFont /Helvetica >>\nendobj\n",
    `6 0 obj\n<< /Type /Annot /Subtype /Link /Rect [72 110 200 130] /Border [0 0 0] /A << /S /URI /URI (${url}) >> >>\nendobj\n`
  ];
  ...
  await fs.writeFile(filename, Buffer.from(pdf, "utf8"));
