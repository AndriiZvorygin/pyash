...
const expected = [
  ...
  "su name alpha ob text \"one\" ya",
  "su name beta ob num 2 ya",
  "su name gamma ob bool truth ya",
  "prah"
];

test("map def golden: run, runjs, runc parity", async () => {
  forget();
  const entryPath = path.resolve("examples/pyash/map-def-golden.pya");
