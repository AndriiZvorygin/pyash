...
test("brief manuscript module keeps staged word-count verifies including total bounds", async () => {
  ...
  assert.match(text, /manuscript fact one complete stage be verify as wo sentence complete from name text output to name map manuscript fact one complete verify do/);
  ...
  assert.match(text, /manuscript fact one complete retry stage be verify as wo sentence complete from name text output to name map manuscript fact one complete verify do/);
  ...
  assert.match(text, /manuscript uplift complete stage be verify as wo sentence complete from name text output to name map manuscript uplift complete verify do/);
  ...
  assert.match(text, /manuscript uplift complete retry stage be verify as wo sentence complete from name text output to name map manuscript uplift complete verify do/);
  ...
  assert.match(text, /manuscript hook complete stage be verify as wo sentence complete from name text output to name map manuscript hook complete verify do/);
  ...
  assert.match(text, /manuscript hook complete retry stage be verify as wo sentence complete from name text output to name map manuscript hook complete verify do/);
  ...
  assert.match(text, /manuscript cta complete retry stage be verify as wo sentence complete from name text output to name map manuscript cta complete verify do/);
  assert.match(text, /fromindex num 1 toindex num 3 be manuscript cta retry do/);
  assert.match(text, /manuscript cta complete stage be verify as wo sentence complete from name text output to name map manuscript cta complete verify do/);
  assert.match(text, /manuscript fact one guarantee stage ob bool lie fromtext text "manuscript fact one constraints defective" be guarantee do/);
  assert.match(text, /manuscript fact two guarantee stage ob bool lie fromtext text "manuscript fact two constraints defective" be guarantee do/);
  assert.match(text, /manuscript uplift guarantee stage ob bool lie fromtext text "manuscript uplift constraints defective" be guarantee do/);
  assert.match(text, /manuscript hook guarantee stage ob bool lie fromtext text "manuscript hook constraints defective" be guarantee do/);
