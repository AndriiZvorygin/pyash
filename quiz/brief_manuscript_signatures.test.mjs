...
test("brief manuscript module keeps staged word-count verifies including total bounds", async () => {
  ...
  assert.match(text, /brief video script source thrust score prompt ob text quoted\.text\.Score whether SCRIPT stays faithful to TRANSCRIPT for source-grounded claims\./);
  ...
  assert.match(text, /manuscript source thrust review atmost num 1 to name text manuscript source thrust score line be line tail do/);
  assert.match(text, /manuscript source thrust score line from text/);
