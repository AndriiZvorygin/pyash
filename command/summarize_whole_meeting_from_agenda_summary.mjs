...
async function main() {
  ...
  process.stdout.write(`[meeting-summary] source agenda summary: ${summaryPath}\n`);
  process.stdout.write(`[meeting-summary] output md: ${outMd}\n`);
  ...
  process.stdout.write(`[meeting-summary] score: ${out.score.toFixed(3)}\n`);
  process.stdout.write(`[meeting-summary] wrote: ${outMd}\n`);
  process.stdout.write(`[meeting-summary] wrote: ${outJson}\n`);
}
