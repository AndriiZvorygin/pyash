...
- Sieve: `examples/pyash/sieve-10.pya`
- Compilation (JS/C): `examples/pyash/compile-fizzbuzz.txt`
- Understanding (parse): `examples/pyash/understand-to-file.pya`
- Mind: `examples/pyash/mind-config-call.pya`
