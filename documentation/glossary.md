...
- **Verb**: Action handler dispatched by `program/bridge/index.mjs` (e.g., `plus`, `giant`, `understand`, `mind`, `read`). Dynamic dispatch verbs (plus/read) load type-specific handlers.
