...
## What works now
- All quizzes green (`node --test quiz`): parser quoting/text, compositional keyword normalization, mind config/use, read filename handler, understand paths, add/generation of result facts, moods `ya/def/do/ret` stored, sandpit execution for ceremonies.
