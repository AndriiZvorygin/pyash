...
* `be remember do` appends to today’s notes.
* `be remember long do` replaces `MEMORY.md`.
...
su name read from filename be can do
su name write ob text to filename be can do
prah
```
