...
| Claim identity, evidence normalization, linked facets, resolver views | `program/library/knowledge_core.mjs` (`normalizeLinkedClaimBundle`, `resolveLinkedClaimBundle`), `program/verbs/claim.mjs`, `program/verbs/exchange/compile/emit_claim.mjs`, `program/verbs/exchange/compile/emit_knowledge.mjs` |
