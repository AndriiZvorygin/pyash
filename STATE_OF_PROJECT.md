...
- `verbs/`: dynamic dispatch (add/subtract/read) and direct verbs (giant, tiny, equally, mind, compile). Mind pulls config from keyword roles (`as`, `accordingto`), read dispatches to handlers, compile builds program JSON.
