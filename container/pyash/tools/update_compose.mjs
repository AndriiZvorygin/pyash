...
const defaultConfigPath = path.join(projectRoot, "configure", "default.pya");
const containerConfigPath = path.join(projectRoot, "configure", "container.pya");
const secretConfigPath = path.join(projectRoot, "configure", "secret.pya");
const legacyWorkplacePath = path.join(projectRoot, "configure", "workplace.pya");
const overridePath = path.join(projectRoot, "container", "pyash", "building", "compose.override.yaml");
...
const lines = [
  "# Generated by container/pyash/tools/update_compose.mjs",
  "services:",
  "  pyash:",
...
if (vncEnabled) {
  ...
  lines.push("    command: [\"/workplace/container/pyash/command/run_vnc_novnc.sh\"]");
}
