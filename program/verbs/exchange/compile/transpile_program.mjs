...
export function transpileProgram(sentences, { lang, sourceLineNumbers, sourceFilename, collectSourceMap, retryConfig, commandPolicy } = {}) {
  ...
  if (lang !== "c") {
    lines = applyJsPrelude(lines, { jsHelpers, usesRememberShim, usesMapShim, mindShim, loopShim, commandPolicy });
  }

  if (lang === "c") {
    lines = applyCPrelude(lines, { cHelpers, mainLines, cState, commandPolicy });
  }
