...
function transpileSentence(sentence, { lang, sentenceArg, locals, ceremonyFns, declared, loopShim } = {}) {
...
function transpileProgram(sentences, { lang }) {
  ...
  for (let i = 0; i < sentences.length; i++) {
    ...
    const line = transpileSentence(sentence, { lang, ceremonyFns, declared, loopShim });
