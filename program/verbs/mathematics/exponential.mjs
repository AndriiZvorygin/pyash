...
export const signatures = [
  ...
  { signatureWords: ["be", "exponential", "obj", "num"], handler: exponential_obj_num_to_name_num },
  { signatureWords: ["be", "exponential", "obj", "name", "num"], handler: exponential_obj_num_to_name_num }
];
