...
import { add, subtract, invert, exponential, multiply, divide, chip, compile, read, mind, giant, tiny, equally } from "../verbs/index.mjs";
...
const verbs = { add, subtract, invert, exponential, multiply, divide, chip, compile, read, mind, giant, tiny, equally };
