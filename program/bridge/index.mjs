...
import { add, subtract, invert, exponential, multiply, divide, produce, chip, compile, read, mind, giant, tiny, equally } from "../verbs/index.mjs";
...
const verbs = { add, subtract, invert, exponential, multiply, divide, produce, chip, compile, read, mind, giant, tiny, equally };
