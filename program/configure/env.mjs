...
const ENV_BINDINGS = [
  ...
  { env: "PYA_SESSION_WINDOW", name: "session window", type: "num" },
  { env: "PYA_SESSION_HISTORY_WINDOW", name: "session history window", type: "num" },
  { env: "PYA_SESSION_SNAPSHOT_ENABLED", name: "session snapshot enabled", type: "bool" },
